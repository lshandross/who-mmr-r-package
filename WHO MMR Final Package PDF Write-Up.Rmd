...
bau_mmr_proj <- 
  cbind(select(mmr_est_unrounded_pwider, name), bau_mmr_proj)
kable(bau_mmr_proj[1:6, 1:5])
kable(bau_mmr_proj[1:6, 6:11])
kable(bau_mmr_proj[1:6, 12:17])
```
...
bau_regional_proj_summaries <- 
  mmr_proj_all_regions(mmr_est_unrounded_pwider, 
                       ...
                       2016, 
                       2030)
knitr::kable(bau_regional_proj_summaries[, 1:4])
knitr::kable(bau_regional_proj_summaries[, 5:11])
knitr::kable(bau_regional_proj_summaries[, 12:16])
...
sdg_mmr_proj <- 
  cbind(select(mmr_est_unrounded_pwider, name), sdg_mmr_proj)
kable(sdg_mmr_proj[1:6, 1:5])
kable(sdg_mmr_proj[1:6, 6:11])
kable(sdg_mmr_proj[1:6, 12:17])
```
