...
#'
#' @examples
bau_mmr_regional_projection_summaries <- function(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year) {

  #collect regional and global summaries, put into list
  Global = global_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  ANZ = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Australia and New Zealand", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  CASA = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Central Asia and Southern Asia", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  EASA = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Eastern Asia and South-eastern Asia", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  LAC = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Latin America and the Caribbean", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  NAE = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Northern America and Europe", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  OOeANZ = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Oceania / Oceania excluding Australia and New Zealand", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  SSA = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Sub-Saharan Africa", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
  WANA = regional_mmr_summary(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, "Western Asia and Northern Africa", arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year)
...
#' @examples
global_mmr_summary <-
  function(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year){
...
#'
#' @examples
regional_mmr_summary <- function(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, sdg1_region, arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year) {
...
bau_mmr_regional_global_graph <- function(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year) {
  bau_mmr_regional_projection_summaries(mmr_pivotwider_tibble, countries_regions_tibble, birth_projections_tibble, arr_start_year_colnum, arr_end_year_colnum, proj_start_year, proj_end_year) %>%
