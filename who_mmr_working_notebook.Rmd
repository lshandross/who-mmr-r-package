...
mmr2030_country <- get_mmr2030_sdg_projections(mmr_est_unrounded_pwider, arr_sdg, 15)
##
...
get_mmr2030_sdg_projections(mmr2015, global_arr, 15) %>% 
  cbind(get_mmr2030_sdg_projections(mmr2015, arr_sdg_predictions, 15)) 
...
#does the calculated sdg arr lead to a global mmr of 70?
  ...
  (sum(get_mmr2030_sdg_projections(mmr2015, sum(arr_sdg_predictions) / 185, 15) * md$Births)) / (sum(md$Births)) #68.754
...
#
(sum(get_mmr2030_sdg_projections(mmr2015, 0.04, 15) * md$Births)) / (sum(md$Births)) #80.325
