...
```{r}
get_arr_sdgtarget <- function(mmr2015_country,
  births2030_country, # vector with births for 2030 for all countries (countries need to be in same order as mmr2015_country)
...
squared_diff <- function(global_arr, mmr2015_country,
  ...
  mmr2030 <- get_mmr2030_sdgprojections(mmr2015_country = mmr2015_country, arr = global_arr, nproject = nproject)
